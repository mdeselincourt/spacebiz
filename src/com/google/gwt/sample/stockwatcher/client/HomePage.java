 ...
 *
 */
public class HomePage extends Content implements PlayerDisplayer {
	...
	public void refresh() {
		...
		logger.info("HomePage.refresh() executing");
...
//		// REMEMBER: This is async, the code that subsequently fires is ABOVE.
	...
	public void displayPlayer(Player player) {
		...
		logger.log(Level.INFO, "HomePage.displayPlayer() invoked and executing");
		...
		else
		{
			...
			logger.log(Level.INFO, "Homepage displaying Player: email = " + gaeUserEmail + " and handle = " + userHandle);
	...
	private void instantiateWidgets() {
		...
		devNotesLabel = new Label("DEV NOTES: Client logging is sent to the Javascript console");
	}
}